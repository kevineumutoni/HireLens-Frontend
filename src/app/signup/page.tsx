...
// All heavy UI pieces live in ./components/ to keep this file clean.
// Functional code (hooks, API, validation) is untouched.
...
export default function SignupPage() {
  ...
  const onSubmit = async (v: FormValues) => {
    try {
      await signupApi(v.firstName, v.lastName, v.email, v.password);
      toast.success("Account created! Please sign in.");
      router.push("/login");
    } catch (e: any) {
      toast.error(e?.response?.data?.detail || e?.message || "Signup failed");
    }
  };
  ...
  return (
    <>
      ...
      <div style={{ minHeight: "100vh", display: "flex", fontFamily: "'Inter', system-ui, sans-serif" }}>
        ...
        {/* ═══════════════════════════════════════════════
            LEFT — brand panel (mirrors login exactly)
        ═══════════════════════════════════════════════ */}
        <div
          style={{
            flex: "0 0 46%",
        ...
        >
          ...
          <div style={{ position: "relative" }}>
            ...
            <h2 style={{
              ...
              lineHeight: 1.18, marginBottom: 14, letterSpacing: "-0.02em",
            }}>
            ...
            <p style={{
              ...
              lineHeight: 1.65, marginBottom: 36, maxWidth: 330,
            }}>
            ...
            <div style={{
              ...
              <p style={{ fontSize: 13, color: "rgba(255,255,255,0.80)", margin: 0, lineHeight: 1.6, fontStyle: "italic" }}>
        ...
        <div style={{
          ...
          <div style={{ width: "100%", maxWidth: 420 }}>
            ...
            <div style={{ marginBottom: 28 }}>
              <h1 style={{ fontSize: 26, fontWeight: 800, color: "#0F172A", letterSpacing: "-0.02em", marginBottom: 6, marginTop: 0 }}>
                Create your account
              </h1>
              <p style={{ fontSize: 14, color: "#64748B", margin: 0 }}>
                Set up your HireLens recruiter workspace.
              </p>
            </div>

            {/* Google button */}
            <button
              type="button" onClick={onGoogle} disabled={googleBusy}
              style={{
            ...
            <form onSubmit={handleSubmit(onSubmit)} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <div>
                ...
                <FieldInput
                  ...
                  {...pwdField}
                  onChange={(e) => { pwdField.onChange(e); setPasswordValue(e.target.value); }}
                />
              ...
              <div>
                <label style={{
                  ...
                  <input type="checkbox" style={{ marginTop: 2, width: 15, height: 15, accentColor: "#2C7CF2", flexShrink: 0, cursor: "pointer" }} {...register("agree")} />
                    ...
                    {["Terms & Conditions", "Privacy Policy"].map((label, i) => (
                      <span key={label}>
                        <button type="button" onClick={() => setShowTerms(true)} style={{
                          ...
                          color: "#2C7CF2", fontWeight: 700, fontSize: 13,
              ...
              <button
                ...
                style={{
                  ...
                  marginTop: 2, boxSizing: "border-box", fontFamily: "inherit",
                }}
              ...
              <p style={{ textAlign: "center", fontSize: 14, color: "#64748B", margin: "4px 0 0" }}>
                ...
                <Link href="/login" style={{ color: "#2C7CF2", fontWeight: 700, textDecoration: "none" }}
