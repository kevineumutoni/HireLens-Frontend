"use client";
// src/app/(protected)/screening/ScreeningProgressModal.tsx
...
export function ScreeningProgressModal({
  logs, jobTitle, total, done, onClose, finished,
}: Props) {
  ...
  return (
    <>
      <div style={{
        ...
        background: "rgba(13,27,62,0.55)", backdropFilter: "blur(5px)",
      }} />
      ...
      <div style={{
        ...
        <div style={{
          ...
          boxShadow: "0 24px 64px rgba(44,124,242,0.20)",
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <div>
                <h2 style={{ fontSize: 14, fontWeight: 800, color: "#fff", margin: 0 }}>
                  {finished ? "Screening Complete" : "AI Screening in Progress"}
                </h2>
          ...
          <div style={{ padding: "16px 22px 0" }}>
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8 }}>
              <span style={{ fontSize: 12, fontWeight: 700, color: "#374151" }}>
                {finished ? "All done" : `Screening ${done} of ${total}…`}
              </span>
            ...
            <div style={{ width: "100%", height: 8, borderRadius: 99, background: "#F1F5F9", overflow: "hidden" }}>
              <div style={{
                ...
                width: `${pct}%`,
                background: finished ? "linear-gradient(90deg,#10B981,#34D399)" : `linear-gradient(90deg,#1a65d6,${BRAND})`,
          ...
          <div style={{
            ...
            {logs.length === 0
              ? <p style={{ fontSize: 12, color: "#94A3B8", margin: 0 }}>Starting…</p>
              : logs.map((log, i) => (
                <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 7 }}>
                  ...
                  {log.type === "info" && <div style={{ width: 12, height: 12, borderRadius: "50%", background: "#E2E8F0", flexShrink: 0, marginTop: 3 }} />}
                  <span style={{
                    fontSize: 12, lineHeight: 1.5,
                    color: log.type === "error" ? "#DC2626" : log.type === "done" ? "#059669" : "#374151",
                    fontWeight: log.type === "done" || log.type === "error" ? 600 : 400,
                  }}>
                    {log.text}
                  </span>
                </div>
          ...
          {!finished && (
            <p style={{ padding: "0 22px 18px", fontSize: 11, color: "#94A3B8", textAlign: "center", margin: 0 }}>
              Gemini AI is evaluating each candidate — may take 1–3 min for 100+ candidates.
            </p>
          )}
        </div>
      </div>
